...
import { addMaintenanceTemplate } from '@/state/maintenanceTemplate/maintenanceTemplate.actions';
import {
...
import { clearError } from '@/state/maintenanceTemplate/maintenanceTemplate.slice';
import {
...
const AddMaintenanceTemplate = () => {
  ...
  const onSubmit = async (data: MaintenanceTemplateFormData) => {
    ...
    if (addMaintenanceTemplate.fulfilled.match(result)) navigate('/maintenance-template');
  };
      ...
      >
        ...
        >
          ...
          <Box display="flex" gap={2}>
            ...
            >
              {loading ? `${t('maintenanceTemplate.add')}...` : t('maintenanceTemplate.add')}
            </Button>
            <Button
              variant="outlined"
              disabled={loading}
